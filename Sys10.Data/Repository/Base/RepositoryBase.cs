...
namespace Sys10.Data.Repository.Base
{
    public class RepositoryBase<TEntity> : IDisposable, IRepositoryBase<TEntity> where TEntity : ModelBase
    {
        ...
        internal ISys10Context Context;
        ...
        public ISys10Context GetContext()
        {
            return Context;
        }
        ...
        /// <param name="saveLog">Indica se deve ou não salvar log. Se true, considera dados da tabela SystemLogTables</param>
        /// <returns></returns>
        public OperationResult BulkAdd<T>(T entity, int timeOut = 20000, string connectionStringName = "Sys10Context")
        {
        ...
        /// <param name="saveLog">Indica se deve ou não salvar log. Se true, considera dados da tabela SystemLogTables</param>
        /// <returns></returns>
        public OperationResult BulkAddRange<T>(IEnumerable<T> entities, int timeOut = 20000, string connectionStringName = "Sys10Context")
        {
        ...
        /// <param name="saveLog">Indica se deve ou não salvar log. Se true, considera dados da tabela SystemLogTables</param>
        /// <returns></returns>
        public OperationResult BulkEdit<T>(T entity, int timeOut = 20000, string connectionStringName = "Sys10Context")
        {

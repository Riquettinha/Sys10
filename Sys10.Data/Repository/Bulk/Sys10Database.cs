...
namespace Sys10.Data.Repository._BulkBase
{
    public class Sys10Database : IDisposable
    {
        ...
        public Sys10Database(string connectionStringName = "Sys10Context", int timeOut = 20000)
        {
